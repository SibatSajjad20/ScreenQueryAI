  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section className="w-full max-w-7xl mx-auto px-6 py-24">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-display font-bold text-white">Meet the Developer</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="group relative rounded-3xl border border-white/10 glass p-8 transition-all duration-500 hover:-translate-y-1 hover:border-indigo-500/30 hover:shadow-[0_0_40px_-5px_rgba(99,102,241,0.3)]"
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-600 text-2xl shadow-lg shadow-indigo-500/20 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                {'</>'}
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white font-display">Sibat Sajjad</h3>
                <p className="text-sm font-medium text-gradient">Full Stack Web Developer</p>
              </div>
            </div>
            ...
            <div className="mb-8 space-y-3">
              {[
                ...
                <div key={skill.title} className="transition-transform duration-200 hover:translate-x-1">
                  <p className="font-semibold text-slate-200 text-sm">{skill.title}</p>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <a key={link.label} href={link.href} target="_blank" rel="noopener noreferrer"
                  className="relative flex items-center gap-2 rounded-xl border border-white/10 glass px-4 py-2.5 text-sm font-medium text-slate-300 transition-all duration-200 hover:border-indigo-500/50 hover:text-white hover:-translate-y-0.5 hover:shadow-lg hover:shadow-indigo-500/20 overflow-hidden group/btn">
                  <span className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="group relative rounded-3xl border border-white/10 glass p-8 transition-all duration-500 hover:-translate-y-1 hover:border-purple-500/30 hover:shadow-[0_0_40px_-5px_rgba(139,92,246,0.3)]"
            style={{ transformStyle: 'preserve-3d' }}
          >
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-500/20 text-2xl shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-3">
                <Camera className="text-indigo-300" size={26} />
              </div>
              <div>
                <h3 className="text-2xl font-bold text-white font-display">ScreenQuery AI</h3>
                <p className="text-sm font-medium text-gradient">v 1.0.0</p>
              </div>
            </div>

            <p className="mb-6 text-slate-400 leading-relaxed text-sm">
              A Chrome Extension that lets you capture any tab and instantly ask Gemini AI questions about it — debug code, summarize charts, translate UI, all without leaving your browser.
            </p>

            <div className="mb-8 space-y-3">
              {[
                { icon: '📸', title: 'One-Click Capture', desc: 'Screenshots the visible tab instantly via chrome.tabs.captureVisibleTab' },
                { icon: '🤖', title: 'Gemini Vision AI', desc: 'Powered by gemini-2.5-flash-lite for fast multimodal understanding' },
                { icon: '🔒', title: 'Privacy First', desc: 'API key stored locally in chrome.storage.local, never on a server' },
                { icon: '⚡', title: 'Instant Answers', desc: 'Ask anything about your screen and get a response in seconds' },
              ].map((f) => (
                <div key={f.title} className="flex items-start gap-3 transition-transform duration-200 hover:translate-x-1">
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/5 text-base">{f.icon}</span>
                  <div>
            ...
            <div className="flex flex-wrap gap-2">
              {['React', 'Vite', 'Tailwind CSS', 'Chrome MV3', '@google/genai', 'Gemini AI'].map((tag) => (
                <span key={tag}
                  className="relative overflow-hidden rounded-lg border border-white/10 glass px-3 py-1 text-xs font-medium text-slate-400 transition-all duration-200 hover:border-indigo-500/40 hover:text-indigo-300 hover:-translate-y-0.5 cursor-default group/tag">
                  <span className="absolute inset-0 bg-gradient-to-r from-indigo-600/15 to-purple-600/15 opacity-0 group-hover/tag:opacity-100 transition-opacity duration-300" />
      ...
      {/* Footer */}
      <footer className="py-10 px-6 bg-slate-950/40 backdrop-blur-sm border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-indigo-500 flex items-center justify-center">
              <Camera size={14} className="text-white" />
            </div>
            <p className="text-[11px] text-slate-600 font-bold uppercase tracking-widest">© 2026 ScreenQuery AI. All rights reserved.</p>
          </div>
          <div className="flex gap-8 text-[11px] text-slate-600 font-bold uppercase tracking-widest">
